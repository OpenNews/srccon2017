...
The SRCCON schedule lives at [schedule.srccon.org](/schedule), so you'll want to load that link on your phone. The schedule will be posted about a week before SRCCON. You can even mark sessions you want to attend and build your own custom schedule. We'll also post session names outside each room during the conference.
